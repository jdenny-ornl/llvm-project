...
//
//   $ clang -O2 -g -fopenmp -fopenmp-targets=nvptx64-nvidia-cuda test.c \
//       -Rpass=kernel-info -mllvm -kernel-info-end-lto -foffload-lto \
//       -Xlinker -offload-opt=-passes='lto<O2>'
//
//   $ clang -O2 -g -fopenmp -fopenmp-targets=nvptx64-nvidia-cuda test.c \
//       -Rpass=kernel-info -foffload-lto \
//       -Xlinker -offload-opt=-passes='lto<O2>,kernel-info'
//
//   $ opt -disable-output test-openmp-nvptx64-nvidia-cuda.bc \
//       -pass-remarks=kernel-info -kernel-info-end-lto -passes='lto<O2>'
//
//   $ opt -disable-output test-openmp-nvptx64-nvidia-cuda.bc \
//       -pass-remarks=kernel-info -passes='lto<O2>,kernel-info'
// ===---------------------------------------------------------------------===//
